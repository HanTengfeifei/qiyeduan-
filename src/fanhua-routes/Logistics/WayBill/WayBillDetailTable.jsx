  ...
  render() {
    ...
    return (
      <div>
        ...
        <Card>
          <Row style={{paddingBottom:'5px',borderBottom:'1px solid rgb(234, 226, 226)'}} className={'yundan-title'}>
          ...
          <div>
            {cars.map(function (item,index) {
              return  <Card style={{marginBottom:'10px'}}>
                        ...
                        <WayBillDetailChildrenTd item={item}  go={go} _pthis = {_pthis} key={index} style={{ margin: 0 }}></WayBillDetailChildrenTd>
                      </Card>
                    })}
          </div>

...
import { Card, Row, Col, Tabs,Table,Input, Icon,Modal ,Upload,message,Alert,Button} from 'antd';
...
//   }
  ...
  render() {
    ...
    return (
      ...
      <div className={'my-table-title-carHead-center my-custom-padding   htf'}>
        <Modal
          keyboard={true}
          title="导入完成"

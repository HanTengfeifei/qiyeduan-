...
class OrderListYundanChildrenTd extends React.Component {
  ...
  myinputChange(e,cloumn,record){
    ...
    if(cloumn=='final_num'){
      ...
      var gprice = Number(joptions.price)?  Number(joptions.price):0;
      var dfee = Number(joptions.deliver_fee)?Number(joptions.deliver_fee):0;
      var efee = Number(joptions.extra_fee)?Number(joptions.extra_fee):0;
      var money = Number(gprice*allgoodsnums)+Number(dfee)+Number(efee) ;

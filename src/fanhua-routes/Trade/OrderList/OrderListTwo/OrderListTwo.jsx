          ...
          <Col span={24}>
            <Row>
              <div style={{padding:'15px'}}>
                <span style={{fontSize:'20px',fontWeight:'bold'}}>订单管理</span>
              </div>
            </Row>
            <Row>
              <Col span={6}>
              ...
              <Row gutter={8} style={{ marginTop: '10px' }}>
                <Col span={24} >
                  <div style={{marginBottom:'10px',textAlign:'right'}}>
                      <Button style={{verticalAlign:'bottom'}} onClick={(e)=>assetOp.bind(this)(e,'/addorderallbuyer')}>添加采购订单</Button>
                      &nbsp;&nbsp;&nbsp;
                      <Button  style={{verticalAlign:'bottom'}} onClick={(e)=>assetOp.bind(this)(e,'/addOrderallsaler')}>添加销售订单</Button>

...
import OrderListTdTwo from './OrderListTdTwo' ;
...
class OrderListTable extends React.Component {
  ...
  fetch(params = {}) {
    getTableData.bind(this)('order/order-list',{order_status:this.props.order_status,kind:2})
  }
  ...
  myRowClick(e,record){
    ...
    createHistory().push({
      pathname: '/orderlistdetailtwo/?orderid='+record.id
    })
  }

  componentWillReceiveProps(nextProps){
    getTableData.bind(this)('order/order-list',{order_status:nextProps.order_status,kind:2});
  }
